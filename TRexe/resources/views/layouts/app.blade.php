...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <title>TRexe</title>
            ...
            <link rel="stylesheet" href="{{ URL::asset('pickadate/lib/themes/default.css') }}">
            <link rel="stylesheet" href="{{ URL::asset('pickadate/lib/themes/default.date.css') }}">
...
@yield('content')
    ...
    <div class="row column">
      <hr>
      <ul class="menu">
        <li class="float-right">- Designed by Sravanthi kapu (Tony)</li>
      </ul>
    </div>
